      ...
      <div className="cv-workflow-grid">
        ...
        <div className="cv-card cv-workflow-card">
          ...
          <div className="cv-workflow-specs">
            <div className="cv-spec-row">
              ...
              <span className="cv-spec-val">Llama-3-70B-Instruct</span>
            </div>
            <div className="cv-spec-row">
        ...
        <div className="cv-card cv-workflow-card">
          ...
          <div className="cv-workflow-specs">
            <div className="cv-spec-row">
              <span className="cv-spec-key">Model Pipeline</span>
              <span className="cv-spec-val">Qwen-2.5-Coder-32B</span>
            </div>
            <div className="cv-spec-row">
            ...
            <div className="cv-spec-row">
              ...
              <span className="cv-spec-val">4 Bounded Cycles</span>
            </div>
          </div>
        ...
        <div className="cv-card cv-workflow-card">
          ...
          <div className="cv-workflow-specs">
            <div className="cv-spec-row">
              <span className="cv-spec-key">Model Pipeline</span>
              <span className="cv-spec-val">LLaVA-1.6-34B / Local VLM</span>
            </div>
            <div className="cv-spec-row">
              <span className="cv-spec-key">Inference Host</span>
              <span className="cv-spec-val">GPU Local Acceleration</span>
            </div>
            <div className="cv-spec-row">
              ...
              <div className="cv-task-deliverables-section" style={{ marginTop: '1rem' }}>
                <div className="cv-deliverables-header">
                  <span className="cv-deliverables-title">
                    ...
                    Generated Workflow Artifacts ({artifacts.length}):
                  </span>
                </div>
                <div className="cv-deliverables-buttons">
                  {artifacts.map((art) => (
                    ...
                    >
                      ...
                      <span>{art.title} ({art.kind.toUpperCase()})</span>
                    </a>
                  ))}
                </div>
              </div>
